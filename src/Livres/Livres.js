...
export default function Livres() {
  ...
  useEffect(() => {
      axios.get('https://phenixdeals.onrender.com/livre')//Je mets un nouveau endpoint pour crée un nuveau path pour ce nouveau GET request pour fetch que les bijoux 
        .then((response) => {
