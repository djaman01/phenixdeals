...
export default function Decoration() {
  ...
  useEffect(() => {//useEffect is essential for ensuring that the data fetching operation occurs when the component is initially mounted.
      ...
      axios.get('https://phenix-back.onrender.com/decoration')//Je mets un nouveau endpoint pour crée un nuveau path pour ce nouveau GET request pour fetch que les bijoux 
        .then((response) => {
