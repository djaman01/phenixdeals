...
export default function Bijoux() {
  ...
  useEffect(() => {
      ...
      axios.get('https://phenixdeals.onrender.com/bijou')//Je mets un nouveau endpoint pour crée un nuveau path pour ce nouveau GET request pour fetch que les bijoux 
        .then((response) => {
