...
export default function Tableaux() {
  ...
  useEffect(() => {
      axios.get('https://phenix-back.onrender.com/tableau')//Je mets un nouveau endpoint pour crée un nouveau path pour ce nouveau GET request pour fetch que les tableaux
        .then((response) => {
